...
<body>
    ...
    <table id="dg" title="My Users" class="easyui-datagrid" style="width:700px;height:250px"
            url='http://localhost/SOAPP/SOAP/controllers/apiRest.php' method="GET"
...
<div id="dlg-buttons2">
    ...
    function newUser() {
        ...
        url = 'http://localhost/SOAPP/SOAP/controllers/apiRest.php';  
    }
    ...
    url = 'http://localhost/SOAPP/SOAP/controllers/apiRest.php';  // Esta URL solo se necesita si luego vas a hacer algo con POST o PUT
}
    ...
    function editUser() {
        ...
        if (row) {
            ...
            url = 'http://localhost/SOAPP/SOAP/controllers/apiRest.php?cedula=' + row.cedula; 
        }
    }
    ...
    var searchUrl = 'http://localhost/SOAPP/SOAP/controllers/apiRest.php?cedula=' + cedula;
